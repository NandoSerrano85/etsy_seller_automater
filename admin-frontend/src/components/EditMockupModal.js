            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Note: Name changes may not be saved in the current version
                  </p>
                </div>
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  />
                  <p className="mt-1 text-xs text-gray-500">
                    Select a new watermark image to replace the current one. Supports PNG, JPG, and other image formats.
                    Max size: 10MB.
                  </p>
                    ...
                    <div className="mt-3 space-y-3">
                      <div className="flex items-center justify-between p-3 bg-green-50 border border-green-200 rounded-lg">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-green-700">New watermark selected</p>
                            <p className="text-xs text-green-600 truncate max-w-xs">{watermarkFile.name}</p>
                          </div>
                        </div>
                        <button
                          type="button"
