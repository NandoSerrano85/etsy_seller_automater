...
const QuickActions = ({ className = '' }) => {
  ...
  const colorClasses = {
    lavender:
      'bg-gradient-to-br from-lavender-400 to-lavender-500 hover:from-lavender-500 hover:to-lavender-600 text-white shadow-sm hover:shadow-md',
    peach:
      'bg-gradient-to-br from-peach-400 to-peach-500 hover:from-peach-500 hover:to-peach-600 text-white shadow-sm hover:shadow-md',
    ...
    purple:
      'bg-gradient-to-br from-lavender-400 to-lavender-500 hover:from-lavender-500 hover:to-lavender-600 text-white shadow-sm hover:shadow-md',
    green:
      'bg-gradient-to-br from-mint-400 to-mint-500 hover:from-mint-500 hover:to-mint-600 text-white shadow-sm hover:shadow-md',
    orange:
      'bg-gradient-to-br from-peach-400 to-peach-500 hover:from-peach-500 hover:to-peach-600 text-white shadow-sm hover:shadow-md',
  };
    ...
    <div className={`bg-white rounded-xl shadow-sm border border-gray-200 p-4 sm:p-6 ${className}`}>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {actions.map(action => {
          ...
          return (
            <button key={action.id} onClick={action.onClick} className={baseClasses}>
              {content}
            </button>
          );
        })}
      ...
      <div className="mt-6 pt-4 border-t border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <button className="text-blue-600 hover:text-blue-700 text-sm font-medium">View Tutorial</button>
        </div>
      </div>
    </div>
  );
