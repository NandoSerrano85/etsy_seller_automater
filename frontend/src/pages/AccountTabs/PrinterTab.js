    ...
    try {
      ...
      if (result.success) {
        ...
        if (defaultPrinter) {
          ...
          setSelectedPrinterId(result.data[0].id);
        }
      } else {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-sage-900">Printers</h2>
          <p className="text-sage-600 mt-1">Manage your printers and printing capabilities</p>
        </div>

        <button
          onClick={() => setShowCreateModal(true)}
          className="bg-sage-600 hover:bg-sage-700 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center space-x-2"
        >
