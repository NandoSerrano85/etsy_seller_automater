  ...
  persist(
    (set, get) => ({
      ...
      getCacheData: (key) => {
        ...
        console.log(`✅ Using cached data for ${key}, expires in:`, Math.floor((timestamps[key] - now) / 1000 / 60), 'minutes');
        return data[key];
      },
      ...
      getCacheStatus: () => {
        ...
        Object.keys(data).forEach(key => {
          status[key] = {
            ...
            expiresIn: timestamps[key] ? Math.max(0, Math.floor((timestamps[key] - now) / 1000 / 60)) + ' minutes' : 'N/A',
