...
const MockupsGallery = ({ mockupImages, openImageModal }) => {
  ...
  const filteredImages = mockupImages.filter(image =>
  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-semibold text-gray-900">Local Mockups</h3>
        ...
        {filteredImages.map((image, index) => (
          <div key={index} className="card overflow-hidden group">
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-500">Mockup Image</p>
            </div>
          </div>
        ))}
      </div>
