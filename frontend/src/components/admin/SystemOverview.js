...
const SystemOverview = () => {
  ...
  const loadSystemOverview = async () => {
    ...
    try {
      ...
      setRecentActivity([
        { id: 1, type: 'print_job', message: 'Print job completed for Order #12345', timestamp: new Date(Date.now() - 5 * 60 * 1000) },
        { id: 2, type: 'user_login', message: 'New user registration: john@example.com', timestamp: new Date(Date.now() - 15 * 60 * 1000) },
        { id: 3, type: 'organization', message: 'Organization "Acme Corp" upgraded plan', timestamp: new Date(Date.now() - 30 * 60 * 1000) },
        { id: 4, type: 'system', message: 'System backup completed successfully', timestamp: new Date(Date.now() - 2 * 60 * 60 * 1000) },
        { id: 5, type: 'printer', message: 'Printer "HP LaserJet Pro" went offline', timestamp: new Date(Date.now() - 4 * 60 * 60 * 1000) },
      ]);
